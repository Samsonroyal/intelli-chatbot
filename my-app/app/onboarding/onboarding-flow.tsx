      ...
      <div className="rounded-lg border p-4 justify items-center">
        <form onSubmit={handleCreateBusiness} className="w-full">
          ...
          case 9:
            return (
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold">Customize AI Personality</h3>
                <div className="grid gap-4">
                  {Object.entries({
                    ...
                    <div key={key} className="flex items-center space-x-4 p-4 rounded-lg border-2 border-gray-200">
                      <div className="flex-1">
                        <Label className="capitalize">{key}</Label>
                        <p className="text-sm text-gray-500">{description}</p>
                      </div>
                      <Switch
                        checked={formData.aiPersonality?.[key] ?? false}
                        onCheckedChange={(checked) => {
                          setFormData({
                            ...formData,
                            aiPersonality: {
                ...
                <div className="relative h-64 w-full overflow-hidden rounded-xl bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700">
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-white space-y-4">
                    ...
                    <p className="text-lg text-center max-w-md">
                      Your AI assistant is ready to help your customers. Let&apos;s start engaging!
                    </p>
                  </div>                
                </div>
              </div>
